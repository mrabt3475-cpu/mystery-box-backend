...
export default function Leaderboard() {
  ...
  return (
    <div className="premium-bg min-h-screen p-6 pt-24 pb-32">
      ...
      {/* Top 3 Podium - 3D Effect */}
      <div className="flex justify-center items-end gap-4 mb-12">
        {/* 2nd */}
        {leaders[1] && (
          <div className="card-3d glass-premium p-6 text-center transform hover:scale-105" style={{ width: 200 }}>
        ...
        {/* 1st */}
        {leaders[0] && (
          <div className="card-3d glass-premium p-8 text-center glow-pulse transform scale-110 gradient-border" style={{ width: 240 }}>
      ...
      <div className="glass-premium p-6 max-w-3xl mx-auto" style={{ position: 'relative' }}>
        {leaders.slice(3).map((leader, i) => (
          <div key={leader._id} className="category-card flex items-center gap-4 p-4 bg-white/5 rounded-xl mb-3 hover:bg-white/10 transition">
